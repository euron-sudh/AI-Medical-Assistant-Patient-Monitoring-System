...
const SAMPLE_LOGS: AuditLog[] = [
  ...
  { id: "7", user_id: "u6", user_name: "Dr. Robert Kim", user_email: "r.kim@medassist.ai", action: "view", resource_type: "patient_record", resource_id: "p5", patient_id: "p5", ip_address: "198.51.100.10", user_agent: "curl/7.88", status_code: 403, details: { reason: "Access denied - not assigned" }, created_at: new Date(Date.now() - 3600000).toISOString() },
